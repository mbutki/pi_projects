...
from weather.visualizations.spaceship.my_types import Thrust, ShipPos, GridPos
from weather.visualizations.spaceship.utils import to_grid
...
class Ship:
    def __init__(self, pos: GridPos = (0, 0)) -> None:
    ...
    def get_grid_pos(self) -> GridPos:
        return to_grid(self.to_pair(self.pos))
