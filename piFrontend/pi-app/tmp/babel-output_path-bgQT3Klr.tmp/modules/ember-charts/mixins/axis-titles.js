 ...
 * @mixin
 */
var AxisTitlesMixin = Ember.Mixin.create({
  /**
   ...
   * @deprecated
   */
  hasAxisTitles: Ember.computed('hasXAxisTitle', 'hasYAxisTitle', function (key, value) {
   ...
   * @type {Number}
   */
  xAxisTitleHeightOffset: Ember.computed('hasXAxisTitle', 'axisTitleHeight', 'labelPadding', function () {
   ...
   * @type {Number}
   */
  yAxisTitleHeightOffset: Ember.computed('hasYAxisTitle', 'axisTitleHeight', function () {
   ...
   * @type {Number}
   */
  xAxisPositionX: Ember.computed('graphicWidth', 'labelWidthOffset', 'xTitleHorizontalOffset', function () {
   ...
   * @type {Number}
   */
  xAxisPositionY: Ember.computed('graphicBottom', 'labelHeightOffset', 'labelPadding', 'xTitleVerticalOffset', function () {
   ...
   * @type {Number}
   */
  yAxisPositionX: Ember.computed('graphicHeight', 'yTitleVerticalOffset', function () {
