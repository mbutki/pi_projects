...
export default Ember.Mixin.create({
   ...
   * @private
   */
  _innerTickSpacingX: Ember.computed('tickSpacingX', 'tickSpacing', function () {
   ...
   * @private
   */
  _innerTickSpacingY: Ember.computed('tickSpacingY', 'tickSpacing', function () {
  ...
  // # ------------------------------------------------------------------------
  numXTicks: Ember.computed('graphicWidth', '_innerTickSpacingX', 'minXTicks', function () {
  ...
  numYTicks: Ember.computed('graphicHeight', '_innerTickSpacingY', 'minYTicks', function () {
