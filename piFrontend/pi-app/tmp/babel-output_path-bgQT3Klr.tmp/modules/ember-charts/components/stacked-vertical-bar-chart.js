 ...
 */
var StackedVerticalBarChartComponent = ChartComponent.extend(LegendMixin, FloatingTooltipMixin, AxesMixin, FormattableMixin, NoMarginChartMixin, AxisTitlesMixin, {
   ...
   * @type {function}
   */
  sliceSortingFn: Ember.computed('valueSliceSortingFn', 'customSliceSortingFn', 'originalOrderSliceSortingFn', 'sliceSortKey', function () {
   ...
   * @type {function}
   */
  barSortingFn: Ember.computed('valueBarSortingFn', 'customBarSortingFn', 'originalOrderBarSortingFn', 'barSortKey', function () {
