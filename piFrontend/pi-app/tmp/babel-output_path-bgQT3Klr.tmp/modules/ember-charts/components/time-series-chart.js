...
var TimeSeriesChartComponent = ChartComponent.extend(LegendMixin, TimeSeriesLabelerMixin, FloatingTooltipMixin, HasTimeSeriesRuleMixin, AxesMixin, FormattableMixin, NoMarginChartMixin, AxisTitlesMixin, {
  ...
  xDomain: Ember.computed('xBetweenGroupDomain', 'xWithinSeriesDomain', '_hasBarData', '_hasLineData', 'maxNumberOfLabels', function () {
  ...
  yDomain: Ember.computed('_groupedLineData', '_groupedBarData', '_hasBarData', '_hasLineData', 'yAxisFromZero', function () {
  ...
  xGroupScale: Ember.computed('xWithinGroupDomain', 'paddedGroupWidth', 'barPadding', 'barGroupPadding', function () {
  ...
  groupedBarAttrs: Ember.computed('xTimeScale', 'xGroupScale', 'barWidth', 'yScale', 'zeroDisplacement', 'barLeftOffset', function () {
  ...
  legendItems: Ember.computed('xBetweenSeriesDomain', 'xWithinGroupDomain', 'getSeriesColor', 'getSecondarySeriesColor', function () {
    var _this10 = this;
