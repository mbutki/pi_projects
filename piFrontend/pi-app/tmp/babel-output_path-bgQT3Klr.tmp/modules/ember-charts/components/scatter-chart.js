...
var ScatterChartComponent = ChartComponent.extend(LegendMixin, FloatingTooltipMixin, AxesMixin, NoMarginChartMixin, AxisTitlesMixin, {
  ...
  **/
  ...
  legendItems: Ember.computed('hasNoData', 'groupedData', 'getGroupShape', 'getGroupColor', 'displayGroups', 'isShowingTotal', 'totalPointData', function () {
  ...
  pointAttrs: Ember.computed('dotShapeArea', 'getGroupShape', 'xScale', 'yScale', 'displayGroups', 'getGroupColor', function () {
    var _this6 = this;
