...
var HorizontalBarChartComponent = ChartComponent.extend(FloatingTooltipMixin, FormattableMixin, SortableChartMixin, AxisTitlesMixin, {
   ...
   * @override
   */
  xAxisPositionX: Ember.computed('graphicWidth', 'xTitleHorizontalOffset', function () {
   ...
   * @type {Number}
   */
  marginBottom: Ember.computed('labelPadding', 'xTitleVerticalOffset', 'hasXAxisTitle', function () {
  ...
  didInsertElement: function didInsertElement() {
    ...
    this._scheduledRedraw = Ember.run.next(function () {
